...
# load in monitoring data and look-up tables
...
```{r exotics, echo=FALSE, results='hide',}
...
sp_obs<-getChecklist(BirdData[ParkList == params$Park]) %>%  tibble() %>% rename(AOU_Code = 1)
...
```{r concl, child="MORR_conlcusions.Rmd", echo=FALSE, message=FALSE, warning = FALSE, }
